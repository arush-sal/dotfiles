...
PROMPT='$(virtualenv_info)${ret_host} %{$fg[blue]%}%1~%{$reset_color%} $(custom_git_prompt_info)'
...
ZSH_THEME_GIT_PROMPT_DIRTY="%{$fg_bold[blue]%})%{$reset_color%}%{$FG[001]%} ✗✗✗"
ZSH_THEME_GIT_PROMPT_STAGED="%{$fg_bold[blue]%})%{$reset_color%}%{$FG[003]%} +++"
